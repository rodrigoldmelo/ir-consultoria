...
- Ajustado o tom para reduzir repetição do nome do lead: `Dr(a). {Nome}` fica restrito à saudação e, no máximo, um reforço natural. O pedido de CNIS também passou a avisar que as DIRFs/rendimentos serão solicitadas depois para análise mais precisa, sem tentar enviar o passo a passo de DIRF antes do PDF aprovado.
