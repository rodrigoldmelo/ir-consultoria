/**
 * PDF operacional: passo a passo para emitir o CNIS no Meu INSS.
 * Enviado automaticamente na primeira vez que o agente pede o extrato.
 */
...
const FILENAME = "Passo-a-passo-CNIS-IR-Consultoria.pdf";
const RELATIVE = "assets/cnis-passo-a-passo.pdf";

export const CNIS_GUIDE_CAPTION =
  "No passo a passo está tudo detalhado para baixar o CNIS (Extrato de Contribuições) pelo Meu INSS. Caso fique com qualquer dúvida, estou por aqui para ajudar.";
...
/** Uma vez por conversa, depois do pedido de CNIS. */
